...
- UI: sebelum tanggal kegiatan, form ditampilkan terkunci dengan keterangan "Pengisian LPD dibuka mulai <tanggal kegiatan>". Tombol simpan & kirim dinonaktifkan.

Catatan: acuan tanggal memakai waktu Asia/Jakarta agar tidak bergeser sehari.

## Yang perlu Anda putuskan
- Untuk Aturan B: pengisian dibuka mulai **tanggal kegiatan (tanggal mulai)** — ini yang diasumsikan rencana ini. Bila seharusnya baru dibuka setelah kegiatan selesai (`tgl_selesai`), sebutkan dan akan disesuaikan.
